...
#  define __VECTOR_TABLE_ROM_ADDR       0x20000000
#endif
...
memory xrom
{
    ...
    type = rom;
    size = 256k;
    map ( size = 256k, dest_offset=0x20000000, dest=bus:ARM:local_bus);
}
...
memory xram
{
    ...
    type = ram;
    size = 16k;
    map ( size = 16k, dest_offset=0x40000000, dest=bus:ARM:local_bus);
}
