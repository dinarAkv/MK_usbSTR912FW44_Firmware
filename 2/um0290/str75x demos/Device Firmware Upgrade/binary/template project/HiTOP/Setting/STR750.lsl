...
#  define __VECTOR_TABLE_ROM_ADDR       0x20004000
#endif

#ifndef __VECTOR_TABLE_RAM_ADDR
#  define __VECTOR_TABLE_RAM_ADDR       0x20004000
#endif
...
memory xrom
{
    ...
    type = rom;
    size = 256k;
    map ( size = 256k, dest_offset=0x20004000, dest=bus:ARM:local_bus);
}
...
memory xram
{
    ...
    type = ram;
    size = 14k;
    map ( size = 14k, dest_offset=0x40000800, dest=bus:ARM:local_bus);
}
