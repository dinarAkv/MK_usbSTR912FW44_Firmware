...
* Version            : V2.0
* Date               : 09/29/2008
* Description        : Description of the USB Microphone Demo.
********************************************************************************
...
Example description
===================
The USB Audio Speaker demo gives examples of how to use the STR9 USB
...
IN endpoint, transmitting data to the host.

More details about this Demo implementation is given in the User manual 
"UM0290 STR7/STR9 USB developer kit V2.0", available for download from the ST
