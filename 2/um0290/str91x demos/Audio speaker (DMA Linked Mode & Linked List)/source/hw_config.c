...
void DMA_Config(void)
{
  ...
  /* Destination address  */ 
  DMA_InitStruct.DMA_Channel_DesAdd = (u32)(&Stream_Buff0); 
  /* The source bus width is a word (32bits)*/
  DMA_InitStruct.DMA_Channel_SrcWidth = DMA_SrcWidth_Word;
  /* The Destination bus width is a word (32bits)*/
...
void Set_DMA_List(void)
{
  ...
  {
    /* Destination address Stream_Buff1 */
    DMA_InitStruct.DMA_Channel_DesAdd = (u32)(&Stream_Buff1); 
  ...
  {
    /* Destination address Stream_Buff0 */
    DMA_InitStruct.DMA_Channel_DesAdd = (u32)(&Stream_Buff0); 
    Linked_List_Descriptor_Table[1] = (u32)(&Stream_Buff0[24]);
    Linked_List_Descriptor_Table[5] = (u32)(&Stream_Buff0[48]);
    Linked_List_Descriptor_Table[9] = (u32)(&Stream_Buff0[72]);
