...
Example description
===================
This Demo provides a description of how to use the USB on the STR71x devices.
The STR71x device is enumerated as an USB Joystick Mouse, that uses the native
