...
void CBW_Decode(void)
{
  ...
  for (Counter = 15; Counter < Data_Len; Counter++)
  {
    CBW.CB[Counter-15] = Bulk_Data_Buff[Counter];
  }
  ...
  {
    Bot_Abort(BOTH_DIR);
    /* reset the CBW.dSignature to desible the clear feature until receiving 
    a Mass storage reset*/
    CBW.dSignature = 0; 
