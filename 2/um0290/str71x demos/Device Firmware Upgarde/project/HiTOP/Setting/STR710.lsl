...
#  define __VECTOR_TABLE_ROM_ADDR       0x40000000
#endif

#ifndef __VECTOR_TABLE_RAM_ADDR
#  define __VECTOR_TABLE_RAM_ADDR       0x40000000
#endif
...
memory xrom
{
    ...
    type = rom;
    size = 272k;
    map ( size = 272k, dest_offset=0x40000000, dest=bus:ARM:local_bus);
}
...
memory xram
{
    ...
    type = ram;
    size = 64k;
    map ( size = 64k, dest_offset=0x20000200, dest=bus:ARM:local_bus);
}
