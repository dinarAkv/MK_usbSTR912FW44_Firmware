...
#endif
#ifndef __STACK_SVC
#  define __STACK_SVC                   0x4
#endif
#ifndef __STACK_ABT
#  define __STACK_ABT                   0x4
#endif
#ifndef __STACK_UND
#  define __STACK_UND                   0x4
#endif
...
#  define __VECTOR_TABLE_ROM_ADDR       0x40004000
#endif

#ifndef __VECTOR_TABLE_RAM_ADDR
#  define __VECTOR_TABLE_RAM_ADDR       0x40004000
#endif
...
memory xrom
{
    ...
    type = rom;
    size = 272k;
    map ( size = 272k, dest_offset=0x40004000, dest=bus:ARM:local_bus);
}
...
memory xram
{
    ...
    type = ram;
    size = 64k;
    map ( size = 64k, dest_offset=0x20000800, dest=bus:ARM:local_bus);
}
