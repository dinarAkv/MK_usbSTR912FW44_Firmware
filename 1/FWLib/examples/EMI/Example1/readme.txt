...
* Version            : V2.1
* Date               : 12/22/2008
* Description        : Description of the EMI Example 1.
********************************************************************************
...
Example description
===================
This is an EMI 8bits Non-Mux mode example running @ 96 MHz.
It aims to configure the STR9 EMI in 8bits Non-Mux mode.
Hence some bytes are written in external memory mapped on bank0.
