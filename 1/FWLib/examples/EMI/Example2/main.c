...
* Version            : V2.1
* Date               : 12/22/2008
* Description        : This is an EMI 16bits Mux mode example running @ 96MHz.
*                      It aims to configure the STR9 EMI in 16bits Mux mode.
*                      Hence some half words are written in external memory 
*                      mapped on bank0.
********************************************************************************
...
int main()
{
  ...
  while (1)
  {
    ...
    *(u16*)0x3C000002 = 0xCCDD;
    *(u16*)0x3C000004 = 0xEEFF;
    *(u16*)0x3C000006 = 0xCBCB;
  }
}
/*******************************************************************************
